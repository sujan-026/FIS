  ...
  const nextButtonFunction = async () => {
    ...
    if (currentStep < steps.length - 1) {
      if (currentStep === steps.length - 2) {
        ...
        if (allFieldsValid) {
          console.log("Validation Successful with all input data");
      ...
      <section className=" flex flex-col justify-between p-24">
        ...
        <FormProvider register={register} errors={errors}>
          <form onSubmit={handleSubmit(processForm)} className="mt-12 py-12">
            ...
            {currentStep === 6 ? (
              <div className="text-center font-semibold text-black mt-5 text-xl">
                Completed
              </div>
            ) : (
              <div className="text-center font-semibold text-red-6007 mt-5 text-xl">
